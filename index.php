        ...
        <div class="text-tentang">
          <div class="head-tentang">
            ...
            <p class="justify">
              ...
              didirikan sejak tahun 2006 dan merupakan salah satu satuan
              pendidikan Taman Kanak-Kanak yang berlokasi di Jalan Merdeka No.
              603-601, Mariana, Kecamatan Pontianak Kota, Kota Pontianak,
              Kalimantan Barat 78244. Jam operasional hari Senin sampai Jumat,
              pukul 7.00 AM - 4.50 PM dan hari Sabtu 8.00 AM - 1.00 PM
            </p>
          </div>
          <div class="isi-tentang">
            <div class="first-text-tentang">
              <p class="bold">Lingkungan dan Pembelajaran</p>
              <p class="justify">
                Sunshine menciptakan pengalaman belajar yang menyenangkan
            ...
            <div class="second-text-tentang">
              <p class="bold">Pengembangan</p>
              <p class="justify">
                Sunshine mendukung perkembangan anak dari akademik, kesehatan,
