            ...
            <form action="" method="POST" class="form-card">
                ...
                <div class="row g-4">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label">Janji <span class="required">*</span></label>
                                <textarea class="form-control" name="janji" required autocomplete="off" placeholder="Masukkan janji"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <button type="submit" name="update-janji" class="btn-form">
                    Simpan Perubahan
                </button>
            </form>
