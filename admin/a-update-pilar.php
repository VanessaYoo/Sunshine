...
<head>
    ...
    <title>Update Pilar Janji</title>
        ...
        <div class="content-ua admin-page">
            ...
            <form action="" method="POST" class="form-card">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Pilar Janji <span class="required">*</span></label>
                            <input class="form-control" type="text" name="pilar" required autocomplete="off" placeholder="Masukkan pilar janji">
                        </div>
                    </div>
                ...
                <button type="submit" name="update-pilar" class="btn-form">
                    Simpan Perubahan
                </button>
            </form>
