            ...
            <div class="form-card">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="view-data">
                            <p>Alamat</p>
                            <p class="black">Jl. Paini Bardan, No. 36, Kecamatan Timur, Pontianak Timur, Kalimantan Barat, Indonesia</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="view-data">
                            ...
                            <p class="black">0812-3456-7890</p>
                        </div>
                    </div>
